...
import Data.ByteString.Char8 as ByteString hiding (foldr, map)
...
parseDataLayout defaultEndianness str =
  let num :: Parser Word32
   ...
   in case parseOnly (parseSpec `sepBy` (char '-')) str of
